...
import com.docker.cirlev2.databinding.Circlev2ItemCirclePersionContentBinding;
import com.docker.cirlev2.databinding.Circlev2ItemCirclePersionHeaderBinding;
import com.docker.cirlev2.vo.entity.TradingCommonVo;
import com.docker.common.common.adapter.SectionBaseViewHolder;
import com.docker.common.common.adapter.SectionedRecyclerViewAdapter;
...
public class CirclePersionListAdapter extends SectionedRecyclerViewAdapter<SectionBaseViewHolder, SectionBaseViewHolder, SectionBaseViewHolder> {
    ...
    protected SectionBaseViewHolder onCreateSectionHeaderViewHolder(ViewGroup parent, int viewType) {
        ViewDataBinding binding = DataBindingUtil.inflate(LayoutInflater.from(context),
                R.layout.circlev2_item_circle_persion_header,
                parent,
                false);
    ...
    protected SectionBaseViewHolder onCreateItemViewHolder(ViewGroup parent, int viewType) {
        ViewDataBinding binding = DataBindingUtil.inflate(LayoutInflater.from(context), R.layout.circlev2_item_circle_persion_content, parent, false);
        SectionBaseViewHolder viewHolder = new SectionBaseViewHolder(binding.getRoot());
        viewHolder.setBinding(binding);
        return viewHolder;
    }
    ...
    protected void onBindSectionHeaderViewHolder(SectionBaseViewHolder holder, int section) {
        Circlev2ItemCirclePersionHeaderBinding headerBinding = (Circlev2ItemCirclePersionHeaderBinding) holder.getBinding();
    ...
    protected void onBindItemViewHolder(SectionBaseViewHolder holder, int section, int position) {
        Circlev2ItemCirclePersionContentBinding itembinding = (Circlev2ItemCirclePersionContentBinding) holder.getBinding();
