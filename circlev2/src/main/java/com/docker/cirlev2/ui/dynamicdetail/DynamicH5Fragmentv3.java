...
import com.docker.cirlev2.databinding.Circlev2FragmentDetailH5V5Binding;
...
public class DynamicH5Fragmentv3 extends NitCommonFragment<CircleDynamicDetailViewModel, Circlev2FragmentDetailH5V5Binding> {

    public ServiceDataBean serviceDataBean;
    private com.tencent.smtt.sdk.WebView webView;

    public static DynamicH5Fragmentv3 getInstance(ServiceDataBean serviceDataBean) {
        DynamicH5Fragmentv3 dynamicH5Fragment = new DynamicH5Fragmentv3();
    ...
    protected int getLayoutId() {
        return R.layout.circlev2_fragment_detail_h5_v5;
    }
