...
import com.docker.active.databinding.ProActiveManagerDetailBinding;
...
import com.docker.active.vo.card.ActiveInfoCard;
import com.docker.active.vo.card.ActiveManagerCard;
...
//                mBinding.empty.showLoading();
    ...
    private void processImg() {
        ...
        options.diskCacheStrategy(DiskCacheStrategy.ALL)
                ...
                .centerCrop();
        Glide.with(ActiveManagerDetailActivity.this)
