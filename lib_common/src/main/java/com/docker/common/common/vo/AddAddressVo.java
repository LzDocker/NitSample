...
public class AddAddressVo extends BaseCardVo {

    public AddAddressVo(int style, int position) {
    ...
    public transient ItemBinding<AddAddressVo> itemBinding = ItemBinding.<AddAddressVo>of(BR.item,
