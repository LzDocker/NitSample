package com.docker.common.common.widget.popwindow;
...
public class CommonPopuwindow extends PopupWindow {
    ...
    private CommonPopuwindow(Context context) {
    ...
    public static class Builder {
        ...
        public CommonPopuwindow create() {
            final CommonPopuwindow popupWindow = new CommonPopuwindow(params.mContext);
        ...
        public CommonPopuwindow create(ReplyCommandParam replyCommandParam) {
            final CommonPopuwindow popupWindow = new CommonPopuwindow(params.mContext);
            params.apply(popupWindow.controller);
            replyCommandParam.exectue(popupWindow.controller.mPopupView);
            if (listener != null && params.layoutResId != 0) {
                listener.getChildView(popupWindow.controller.mPopupView, params.layoutResId);
            }
            measureWidthAndHeight(popupWindow.controller.mPopupView);
