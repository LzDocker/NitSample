...
public abstract class CommonBaseDialog extends DialogFragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setStyle(DialogFragment.STYLE_NO_TITLE, R.style.common_BaseDialog);
     ...
     * @return
     */
    public CommonBaseDialog setDimAmout(@FloatRange(from = 0, to = 1) float dimAmount) {
     ...
     * @return
     */
    public CommonBaseDialog setShowBottom(boolean showBottom) {
     ...
     * @return
     */
    public CommonBaseDialog setSize(int width, int height) {
        mWidth = width;
        mHeight = height;
        return this;
    }
     ...
     * @return
     */
    public CommonBaseDialog setMargin(int margin) {
        mMargin = margin;
        return this;
    }
     ...
     * @return
     */
    public CommonBaseDialog setAnimStyle(@StyleRes int animStyle) {
     ...
     * @return
     */
    public CommonBaseDialog setOutCancel(boolean outCancel) {
        mOutCancel = outCancel;
        return this;
    }

    public CommonBaseDialog show(FragmentManager manager) {
//        super.show(manager, String.valueOf(System.currentTimeMillis()));
     ...
     * @param dialog
     */
    public abstract void convertView(ViewHolder holder, CommonBaseDialog dialog);
