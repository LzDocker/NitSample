...
public abstract class NitAbsSampleAdapter<T> extends CommonRecyclerAdapter<T, CommonRecyclerAdapter.ViewHolder<ViewDataBinding>> {
    ...
    public NitAbsSampleAdapter(int layoutId, int brId) {
        super(layoutId, brId);
    }
