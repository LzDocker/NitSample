...
//                str = "今天" + sdf.format(d2);
    ...
    public static boolean isShowSingleImg(List<ResourceBean> resource) {
    ...
    public static String getCommentSingleImg(List<ResourceBean> resource) {
        if (resource == null || resource.size() == 0) {
            return "";
        }
        if (resource.get(0).getImg() != null) {
    ...
    public static boolean isShowCommentVideoImg(List<ResourceBean> resource) {
        if (resource == null || resource.size() == 0) {
            return false;
        }
...
//    public static int getLevelDrable(String warn) {
//        if (TextUtils.isEmpty(warn)) {
//            return R.drawable.circle_lable_shape1;
//        }
//        int drable = R.drawable.circle_lable_shape1;
//        switch (warn) {
//            case "信息警报":
//                drable = R.drawable.circle_lable_shape2;
//                break;
//            case "警告警报":
//                drable = R.drawable.circle_lable_shape1;
//                break;
//            case "紧急警报":
//                drable = R.drawable.circle_lable_shape3;
//                break;
//        }
//        return drable;
//    }
