 ...
 * 通用容器单一fragment
 * */
@Route(path = AppRouter.COMMON_CONTAINER_NO_REFRESH_FRAGMENTV2)
public class NitCommonContainerNoRefreshFragmentV2 extends NitCommonListNoRefreshFragment<NitCommonContainerViewModel> {

    private NitDelegetCommand delegetCommand;

    public static NitCommonContainerNoRefreshFragmentV2 newinstance(CommonListOptions commonListReq) {
        NitCommonContainerNoRefreshFragmentV2 nitCommonContainerFragment = new NitCommonContainerNoRefreshFragmentV2();
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if (commonListReq.isActParent) {
            ...
            delegetCommand = ((NitCommonFragment) (NitCommonContainerNoRefreshFragmentV2.this.getParentFragment())).providerNitDelegetCommand(commonListReq.falg);
        }
