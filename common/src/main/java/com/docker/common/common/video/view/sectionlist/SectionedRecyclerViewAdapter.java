package com.docker.common.common.video.view.sectionlist;
...
public class SectionedRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    /**
     * Helper method that calls {@link #notifyItemChanged} with the position of the {@link }
     ...
     * the position of the {@link } view holder in the adapter. Useful to be called after
    ...
    /**
     * Helper method that calls {@link #notifyItemChanged} and {@link #notifyItemInserted} with
     * the position of the view holder in the adapter. Useful to be called after
     * changing the State from LOADING/ FAILED/ EMPTY to LOADED.
     *
     * @param section       a visible section of this adapter
     * @param previousState previous state of section
