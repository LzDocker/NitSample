package com.docker.common.common.video.view.control;
...
import com.docker.common.common.video.constants.PlayParameter;
import com.docker.common.common.video.theme.ITheme;
import com.docker.common.common.video.utils.TimeFormater;
import com.docker.common.common.video.view.interfaces.LessChooseListener;
import com.docker.common.common.video.view.interfaces.ViewAction;
import com.docker.common.common.video.view.quality.QualityItem;
...
public class ControlView extends RelativeLayout implements ViewAction, ITheme {
    ...
    private TextView txtRight, txtCh, txtEn;//右上角
...
//    private SeekBar.OnSeekBarChangeListener seekBarChangeListener;
    ...
    public void setCHEN(String... s) {
        if (s != null) {
            ...
            txtCh.setText(s[0]);
            txtRight.setText(s[0]);
            txtCh.setBackgroundResource(R.drawable.shape_progressbar_bg);
            String en = s[1];
    ...
    private LessChooseListener lessChooseListener;

    public void setChooseLessonListener(LessChooseListener lessonListener) {
        this.lessChooseListener = lessonListener;
    }

    OnClickListener lessClick = new OnClickListener() {
        @Override
        public void onClick(View view) {
            relativeRight.setVisibility(View.GONE);
            if (view.getId() == txtCh.getId()) {
                txtCh.setTextColor(Color.parseColor("#FFFC9630"));
                txtEn.setTextColor(Color.parseColor("#FFFFFF"));
//                txtEn.setBackgroundResource(R.drawable.shape_progressbar_bg2);
                txtRight.setText(txtCh.getText());
                if (lessChooseListener != null)
                    lessChooseListener.onLessChange(0);
            } else {
                txtCh.setTextColor(Color.parseColor("#FFFFFF"));
                txtEn.setTextColor(Color.parseColor("#FFFC9630"));
                txtRight.setText(txtEn.getText());
//                txtEn.setBackgroundResource(R.drawable.shape_progressbar_bg);
//                txtCh.setBackgroundResource(R.drawable.shape_progressbar_bg2);
                if (lessChooseListener != null)
                    lessChooseListener.onLessChange(1);
            }
    ...
    private void findAllViews() {
        ...
        txtRight = findViewById(R.id.alivc_title_right);
        relativeRight = findViewById(R.id.alivc_right_relative);

        txtCh = findViewById(R.id.alivc_right_relative_ch);
        txtEn = findViewById(R.id.alivc_right_relative_ens);
        txtEn.setOnClickListener(lessClick);
        txtCh.setOnClickListener(lessClick);
...
//            mScreenShot.setVisibility(GONE);
    ...
    private static class HideHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (controlView != null) {
//                /111
                controlView.relativeRight.setVisibility(GONE);
    ...
    public void setScreenMode(int i) {
        mScreenModeBtn.setVisibility(i);
    }
}
