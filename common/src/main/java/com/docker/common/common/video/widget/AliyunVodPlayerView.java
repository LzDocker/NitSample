package com.docker.common.common.video.widget;
...
import com.docker.common.common.video.utils.FixedToastUtils;
import com.docker.common.common.video.utils.ImageLoader;
import com.docker.common.common.video.utils.NetWatchdog;
import com.docker.common.common.video.utils.OrientationWatchDog;
import com.docker.common.common.video.utils.ScreenUtils;
import com.docker.common.common.video.view.control.ControlView;
import com.docker.common.common.video.view.gesture.GestureDialogManager;
import com.docker.common.common.video.view.gesture.GestureView;
import com.docker.common.common.video.view.guide.GuideView;
...
import com.docker.common.common.video.view.more.SpeedValue;
import com.docker.common.common.video.view.quality.QualityView;
import com.docker.common.common.video.view.speed.SpeedView;
import com.docker.common.common.video.view.tipsview.TipsView;
...
//        initGuideView();
    ...
    public void setCurrentVolume(int progress) {
        Log.e("ALIYUNPLayer", "setCurrentVolume" + progress);
        ...
        mGestureView.setOnGestureListener(new GestureView.GestureListener() {
            ...
            public void onRightVerticalDistance(float downY, float nowY) {
                ...
                if (mGestureDialogManager != null) {
                    ...
                    Log.e("AliYunVod", "onRightVerticalDistance:" + targetVolume);
...
//            RequestOptions options = new RequestOptions();
            GlideApp.with(mCoverView).load(uri).transition(withCrossFade()).into(mCoverView);
    ...
    public void setSeekBarChangeListener(SeekBar.OnSeekBarChangeListener seekBarChangeListener) {
        ...
        mControlView.setSeekBarChangeListener(seekBarChangeListener);

    }

    public void setCHEN(String... s) {
        this.mControlView.setCHEN(s);
    }


    public void setChooseLessonListener(LessChooseListener clickListener) {
        this.mControlView.setChooseLessonListener(clickListener);
    }
