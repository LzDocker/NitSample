    ...
    public void asyncPutObjectWithServerCallback() {
        ...
        OSSAsyncTask task = oss.asyncPutObject(put, new OSSCompletedCallback<PutObjectRequest, PutObjectResult>() {
            ...
            public void onSuccess(PutObjectRequest request, PutObjectResult result) {
                ...
                LogUtils.e("servercallback", serverCallbackReturnJson);
            }
    ...
    public void appendObject() {
        ...
        append.setProgressCallback(new OSSProgressCallback<AppendObjectRequest>() {
            ...
            public void onProgress(AppendObjectRequest request, long currentSize, long totalSize) {
                LogUtils.e("AppendObject", "currentSize: " + currentSize + " totalSize: " + totalSize);
            }
        });
        ...
        OSSAsyncTask task = oss.asyncAppendObject(append, new OSSCompletedCallback<AppendObjectRequest, AppendObjectResult>() {
            ...
            public void onSuccess(AppendObjectRequest request, AppendObjectResult result) {
                LogUtils.e("AppendObject", "AppendSuccess");
                LogUtils.e("NextPosition", "" + result.getNextPosition());
            }
