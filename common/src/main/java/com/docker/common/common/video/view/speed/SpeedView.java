package com.docker.common.common.video.view.speed;
...
public class SpeedView extends RelativeLayout implements ITheme {
    ...
    private void init() {
        ...
        //倍速view使用到的动画
        showAnim = AnimationUtils.loadAnimation(getContext(), com.docker.common.R.anim.view_speed_show);
        hideAnim = AnimationUtils.loadAnimation(getContext(), com.docker.common.R.anim.view_speed_hide);
