...
import com.docker.video.AVPlayer;
...
import com.docker.video.extension.NetworkEventProducer;
import com.docker.video.log.PLog;
import com.docker.video.player.IPlayer;
import com.docker.video.provider.IDataProvider;
...
import com.docker.video.render.RenderSurfaceView;
import com.docker.video.render.RenderTextureView;
import com.docker.video.style.IStyleSetter;
import com.docker.video.style.StyleSetter;
/** 基类播放器View 内核是阿里云播放器
 *
