...
import com.bfhd.circle.databinding.CircleActivityCircleReplayQuestionBinding;
 ...
 * 回复问答
 * */
public class CircleReplayQuestionActivity extends HivsBaseActivity<CircleDynamicViewModel, CircleActivityCircleReplayQuestionBinding> {
    ...
    public static void startMe(Context context, ServiceDataBean serviceDataBean) {
        ...
        Intent intent = new Intent(context, CircleReplayQuestionActivity.class);
    ...
    protected int getLayoutId() {
        return R.layout.circle_activity_circle_replay_question;
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mViewModel.items.add(serviceDataBean);
    ...
    public void OnVmEnentListner(ViewEventResouce viewEventResouce) {
        ...
        switch (viewEventResouce.eventType) {
            ...
            case 211:
                ...
                commentVo.setContent(mBinding.activityAnswerEt.getText().toString());
                commentVo.setPraiseNum("0");
                commentVo.isDo = 0;
                commentVo.setInputtime(System.currentTimeMillis() + "");
                if (mBinding.activityQuizTvReRecord.getVisibility() == View.VISIBLE && !TextUtils.isEmpty(audioUrl)) {
                    commentVo.setAudio(audioUrl);
                    commentVo.setAudio_duration(mBinding.activityQuizTvTime.getText().toString().substring(0, mBinding.activityQuizTvTime.getText().toString().indexOf("'")));
                }
                audioUrl = "";
