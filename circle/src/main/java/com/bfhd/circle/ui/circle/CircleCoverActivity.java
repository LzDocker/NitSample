...
//                    .recordVideoSecond(15)//录制视频秒数 默认60s
    ...
    private void TakePicture() {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
             ...
             */
            uri = FileProvider.getUriForFile(this, "com.bfhd.safe.fileProvider", mfile);
        }
    ...
    public void initView() {
        ...
        mBinding.refresh.setOnLoadMoreListener(refreshLayout -> ((CommonFragment) fragmentList.get(mBinding.viewPager.getCurrentItem())).OnLoadMore(mBinding.refresh));
        ...
        mBinding.tvSubmit.setOnClickListener(v -> {
            ...
            ((CommonFragment) (fragmentList.get(0))).OnRefresh(mBinding.refresh);
