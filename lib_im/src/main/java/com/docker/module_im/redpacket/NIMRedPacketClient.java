package com.docker.module_im.redpacket;
 ...
 * 4.红包消息、拆红包消息分别使用自定义消息，参考 {com.netease.nim.demo.session.extension.RedPacketAttachment}、
 * { com.netease.nim.demo.session.extension.RedPacketOpenedAttachment},在调用金融魔方接口发送红包成功之后，发送
