package com.docker.module_im.contact.activity;
...
import com.docker.module_im.contact.constant.UserConstant;
import com.docker.module_im.contact.helper.UserUpdateHelper;
...
public class UserProfileEditItemActivity extends UI implements View.OnClickListener {
    ...
    public void onClick(View v) {
        int i = v.getId();
        if (i == R.id.male_layout) {
            gender = GenderEnum.MALE.getValue();
            genderCheck(gender);
        } else if (i == R.id.female_layout) {
            gender = GenderEnum.FEMALE.getValue();
            genderCheck(gender);
        } else if (i == R.id.other_layout) {
            gender = GenderEnum.UNKNOWN.getValue();
            genderCheck(gender);
        } else if (i == R.id.birth_picker_layout) {
            openTimePicker();
        }
    }
