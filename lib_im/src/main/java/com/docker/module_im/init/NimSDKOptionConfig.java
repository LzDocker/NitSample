...
import com.docker.module_im.DemoPrivatizationConfig;
...
//        options.mixPushConfig = buildMixPushConfig();
    ...
    public static void configServerAddress(final SDKOptions options, Context context) {
...
//        config.notificationEntrance = SplashActivity.class;
        config.notificationSmallIconId = R.mipmap.open_up_pic_icon;
        config.notificationColor = DemoCache.getContext().getResources().getColor(com.docker.module_im.R.color.color_blue_3a9efb);
        // 通知铃声的uri字符串
    ...
    public static MessageNotifierCustomization messageNotifierCustomization = new MessageNotifierCustomization() {
