package com.docker.module_im.session;
...
import com.docker.module_im.contact.activity.RobotProfileActivity;
import com.docker.module_im.contact.activity.UserProfileActivity;
import com.docker.module_im.redpacket.NIMRedPacketClient;
import com.docker.module_im.session.action.AckMessageAction;
import com.docker.module_im.session.action.FileAction;
import com.docker.module_im.session.action.GuessAction;
import com.docker.module_im.session.action.RTSAction;
import com.docker.module_im.session.action.SnapChatAction;
import com.docker.module_im.session.action.TipAction;
import com.docker.module_im.session.activity.AckMsgInfoActivity;
import com.docker.module_im.session.activity.MessageHistoryActivity;
import com.docker.module_im.session.activity.MessageInfoActivity;
import com.docker.module_im.session.extension.CustomAttachParser;
import com.docker.module_im.session.extension.CustomAttachment;
import com.docker.module_im.session.extension.GuessAttachment;
import com.docker.module_im.session.extension.RTSAttachment;
import com.docker.module_im.session.extension.RedPacketAttachment;
import com.docker.module_im.session.extension.RedPacketOpenedAttachment;
import com.docker.module_im.session.extension.SnapChatAttachment;
import com.docker.module_im.session.extension.StickerAttachment;
import com.docker.module_im.session.search.SearchMessageActivity;
import com.docker.module_im.session.viewholder.MsgViewHolderDefCustom;
import com.docker.module_im.session.viewholder.MsgViewHolderFile;
import com.docker.module_im.session.viewholder.MsgViewHolderGuess;
import com.docker.module_im.session.viewholder.MsgViewHolderRTS;
import com.docker.module_im.session.viewholder.MsgViewHolderSnapChat;
import com.docker.module_im.session.viewholder.MsgViewHolderSticker;
import com.docker.module_im.session.viewholder.MsgViewHolderTip;
