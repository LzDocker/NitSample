...
import com.docker.module_im.contact.activity.UserProfileSettingActivity;
import com.docker.module_im.jsbridge.JsBridgeActivity;
import com.docker.module_im.main.adapter.SettingsAdapter;
import com.docker.module_im.main.model.SettingTemplate;
import com.docker.module_im.main.model.SettingType;
...
//        long size = NIMClient.getService(LuceneService.class).getCacheSize();
        return String.format("%.2f", 100 / (1024.0f * 1024.0f));
    }
