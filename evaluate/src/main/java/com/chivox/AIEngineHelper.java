...
//
//		File filesDir = getFilesDir(context);
//		File serialNumberFile = new File(filesDir, "aiengine"+appKey+".seri");
//		String serialNumber;
...
//			HttpPost httpPost = new HttpPost("http://auth.cloud.chivox.com:8001/device");
...
//	 * @param userId
	 * @return return serialNumber on success, otherwise return null
	 */
//	@SuppressLint("NewApi") public static String registerDeviceOnceTwice(Context context, String appKey, String secretKey,
//			String deviceId, String userId) {
//
//		File filesDir = getFilesDir(context);
//		File serialNumberFile = new File(filesDir, "aiengine.serial");
//		File provisonFile = new File(filesDir, "aiengine.provision.temp");
//
//		Log.d(TAG,"provison path:" + provisonFile.toString());
//
//		String serialNumber;
//		String provision;
//
...
//			String content = EntityUtils.toString(response.getEntity());
//			serialNumber = (String) new JSONObject(content).get("serialNumber");
//			provision = (String) new JSONObject(content).get("provision");
//
//            Log.d(TAG,"content:" + content);
//
//			try
...
//
//			try {
//			      byte [] result = Base64.decode(provision, Base64.DEFAULT);
//			      writeFileAsBytes(provisonFile, result);
//			      Log.d(TAG, "provision: " + provision);
//			      Log.d(TAG, "provision save path: " + provisonFile.getAbsolutePath());
//			} catch (Exception e) {
//				/* ignore */
//			}
//
