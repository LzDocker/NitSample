package com.docker.video_edit.effect.filter;
...
public class GlBilateralFilter extends GlFilter {
    ...
    public GlBilateralFilter() {
        this(1.0f, 0.004f, 0.004f);
    }

    public GlBilateralFilter(float blurSize, float texelWidthOffset, float texelHeightOffset) {
