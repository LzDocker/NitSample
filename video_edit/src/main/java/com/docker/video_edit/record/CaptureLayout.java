...
import com.docker.video_edit.record.listener.ReturnListener;
...
//                resetCaptureLayout();
    ...
    public void iconLeftVisible(boolean visible) {
        iv_custom_left.setVisibility(visible ? View.VISIBLE : View.GONE);
    }

    public void iconRightVisible(boolean visible) {
        iv_custom_right.setVisibility(visible ? View.VISIBLE : View.GONE);
    }

    public void btnReturnVisible(boolean visible) {
        btn_return.setVisibility(visible ? View.VISIBLE : View.GONE);
    }
