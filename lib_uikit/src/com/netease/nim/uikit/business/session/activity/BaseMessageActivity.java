...
public abstract class BaseMessageActivity extends UI {
    ...
    private void addRightCustomViewOnActionBar(UI activity, final List<SessionCustomization.OptionsButton> buttons) {
...
//        }s
        ...
        imageView.setImageResource(buttons.get(0).iconId);
        imageView.setBackgroundResource(R.drawable.nim_nim_action_bar_button_selector);
        imageView.setPadding(ScreenUtil.dip2px(10), 0, ScreenUtil.dip2px(10), 0);
        imageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                buttons.get(0).onClick(BaseMessageActivity.this, v, sessionId);
            }
        });
