...
public class ImgUrlUtil {
    ...
    public static String getCompleteImageUrl(VideoFullEntityVo videoEntityVo) {//云端的图片
        if (videoEntityVo == null) {
            return "";
        }
        if (videoEntityVo.getExtData() == null) {
    ...
    public static String getCompleteVideoUrl(VideoFullEntityVo videoEntityVo) {//云端的图片
        if (videoEntityVo == null) {
            return "";
        }
        if (videoEntityVo.getExtData() == null) {
